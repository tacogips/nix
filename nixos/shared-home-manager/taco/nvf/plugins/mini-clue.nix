    ...
    after = ''
      ...
      miniclue.setup({
        ...
        clues = {
          ...
          { mode = "n", keys = "<Space><Space>q", desc = "Quit without saving" },
          { mode = "n", keys = "<Space>e", desc = "Open yazi" },
          { mode = "n", keys = "<Space>R", desc = "Run current buffer" },
          { mode = "n", keys = "<Space>t", desc = "Open aerial symbols picker" },
          ...
          { mode = "n", keys = "<Space>g", desc = "Open git status picker" },
          { mode = "n", keys = "<Space>G", desc = "Open git branches picker" },
          { mode = "n", keys = "<Space>gc", desc = "Open git commits picker" },
          { mode = "n", keys = "<Space>'", desc = "Open recent files picker" },
          { mode = "n", keys = "<Space>b", desc = "Open buffers picker" },
          ...
          { mode = "n", keys = "<Space>?", desc = "Open keymaps picker" },
          { mode = "n", keys = "<Space>a", desc = "[lsp] Show code actions" },
          { mode = "n", keys = "<Space>S", desc = "[lsp] Open workspace symbols picker" },
          { mode = "n", keys = "<Space>s", desc = "[lsp] Open document symbols picker" },
