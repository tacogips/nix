    ...
    after = ''
      ...
      miniclue.setup({
        ...
        clues = {
          ...
          { mode = "n", keys = "<Space>q", desc = "Force-quit current window" },
          ...
          { mode = "n", keys = "<Space>,", desc = "Open smart files/buffers/history picker" },
          { mode = "n", keys = "<Space>h", desc = "Open file history picker" },
          ...
          { mode = "n", keys = "<Space>s", desc = "[lsp] Open workspace type symbols picker" },
          { mode = "n", keys = "<Space>S", desc = "[lsp] Open workspace non-type symbols picker" },
          { mode = "n", keys = "<Space>W", desc = "[lsp] Open workspace symbols picker" },
