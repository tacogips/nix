# Function to fix library collisions between packages
# Usage: fixLibraryCollision pkgs package [
#   { lib = "lib1.so"; source = sourcePackage1; }
#   { lib = "lib2.so"; source = sourcePackage2; }
# ]
{ pkgs }:

# package: The package that has conflicting libraries
# libSpecs: A list of library specifications, each containing:
#   - lib: The name of the library file (e.g., "libhtml2md.so")
