...
emit({
  ...
  guidance:
    planComplete
      ...
      : nextTask === null
        ? `Delegate ${planPath} to codex-design-and-implement-review-loop to complete plan-level active work before reassessment.`
      : `Delegate ${planPath} to codex-design-and-implement-review-loop to complete ${nextTask.taskId} and remaining active-plan work before reassessment.`,
});
'
