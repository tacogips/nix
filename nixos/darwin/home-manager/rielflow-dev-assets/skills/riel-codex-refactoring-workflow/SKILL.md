...
- Parent workflow: `~/.rielflow/workflows/codex-refactoring-divide-and-conquer`
- Child workflow: `~/.rielflow/workflows/codex-refactoring-slice-review`
...
```bash
rielflow workflow run codex-refactoring-divide-and-conquer --scope user \
...
```bash
rielflow workflow validate codex-refactoring-divide-and-conquer --scope user --output json
rielflow workflow validate codex-refactoring-slice-review --scope user --output json
```
